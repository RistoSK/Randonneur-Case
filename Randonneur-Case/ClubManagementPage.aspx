        ...
        <div id="div_CONTAINER">
            ...
            <div id="div_LEFT0">
                <div id="div_NAV0">
                    ...
                    <br />
                    <asp:HyperLink ID="HyperLinkRiderManagement" runat="server" NavigateUrl="~/RiderManagementPage.aspx.aspx">Rider Management</asp:HyperLink>
                    <br />
                    <asp:HyperLink ID="HyperLinkClubManagement" runat="server" NavigateUrl="~/ClubManagementPage.aspx" BorderStyle="None" CssClass="current_page_link">Club Management</asp:HyperLink>
&nbsp;<br />
                    <br />
            ...
            <div id="div_RIGHT">
                ...
                <div id="div_right_DETAILS">
                    ...
                    <div class="div_right_details_ROW">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorName" runat="server"
                            ...
                            ControlToValidate="tbName" CssClass="validatorMessage"> </asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="div_right_details_ROW">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                            ErrorMessage="Required!" SetFocusOnError="True"
                            ControlToValidate="tbCity" CssClass="validatorMessage"></asp:RequiredFieldValidator>
                    </div>
                ...
                <div id="div_right_VALIDATORS">
                    ...
                    <asp:RangeValidator ID="RangeValidator_ClubID" runat="server"
                        ControlToValidate="tbID" ErrorMessage="Club ID should be between 50 and 4999"
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator_Email" runat="server"
                        ...
                        SetFocusOnError="True" CssClass="validatorMessage"> </asp:RegularExpressionValidator>
